  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-[150] max-w-md mx-auto h-16 px-6 flex items-center justify-between bg-white/95 dark:bg-[#020617]/95 backdrop-blur-md border-b border-slate-100 dark:border-white/5 transition-colors duration-300">
      <div className="flex items-center space-x-2">
        <div className="w-8 h-8 bg-[#002B54] dark:bg-blue-600 rounded-lg flex items-center justify-center text-white shadow-sm transition-transform active:scale-95">
          <Icons.Logo className="w-5 h-5" />
        </div>
        <div className="flex flex-col">
          <span className="text-[14px] font-black text-slate-950 dark:text-white uppercase tracking-tight leading-none">
            Personal<span className="text-[#002B54] dark:text-blue-400">Group</span>
          </span>
          <span className="text-[8px] font-bold text-slate-600 dark:text-slate-400 uppercase tracking-[0.3em] mt-1 ml-px">
            Exclusive
          </span>
        </div>
      </div>
