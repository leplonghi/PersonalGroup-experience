        ...
        <div className="flex items-center space-x-4 flex-1">
          ...
          {!leftAction && showLogo && (
            <div className="flex items-center group cursor-pointer">
              <img src="/header_logo.png" alt="Personal Group Logo" className="h-10 w-auto object-contain transition-all filter drop-shadow-[0_0_8px_rgba(37,99,235,0.3)] group-hover:scale-105" />
            </div>
          )}
        </div>
